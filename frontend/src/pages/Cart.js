                                    ...
                                    <div className='card shadow-sm'>
                                        <div className='row'>
                                            <div className='col-md-4'>
                                                <img src={`http://127.0.0.1:8000${item.food.image}`} style = {{minHeight:'200px' }} className='img-fluid rounded-start'/>
                                            </div>
                                             <div className='col-md-8'>
                                                <div className='card-body'>
                                                    ...
                                                    <button className='btn btn-sm btn-outline-danger mt-3 px-3' onClick={() => deleteCartItem(item.id)}>
