                    ...
                    {/* /* /*to save image use enctype */  }
                     <form onSubmit={handleSubmit} encType='multipart/form-data'> 
                            ...
                            <div className='mb-3 form-check form-switch'>
                              ...
                              onChange={(e) => setFormData({...formData, is_available:e.target.checked}) } checked={formData.is_available}/>
                            ...
                            <div className='mb-3'>
                             ...
                             <div className='row'>
                                ...
                                <div className='col-md-6'>
                                     {formData.image && (
                                        <img src={`http://127.0.0.1:8000/${formData.image}`} className='img-fluid' style={{maxHeight:'100px', padding:'4px', border:'1px solid', borderRadius:'8px'}}/>
                                     )}
                                </div>
                            </div>
                            </div>
